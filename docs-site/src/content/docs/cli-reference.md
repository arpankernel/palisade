...
[`.env.example`](https://github.com/arpankernel/palisade/blob/main/.env.example), or the template in the
[judgment layer guide](/palisade/docs/judgment-layer/)). The process environment wins over
